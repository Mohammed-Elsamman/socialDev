...
module.exports = validateRegisterInput = data => {
    ...
    if (!validator.isLength(data.name, {min: 3, max: 30})) errors.name = "name must be between 3 and 30 charachters";
    ...
    if (!validator.isLength(data.password, {min: 5, max: 20})) errors.password = "password must be between 5 and 20 charachters";
    ...
    if (data.password !== data.password2) errors.password2 = "the tow password field are diffrent";
    return {
        errors,
